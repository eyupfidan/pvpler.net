...
<title>Agario Pvp Serverler | <?=$siteayarlari["siteadi"]?></title>
<meta name="rating" content="general"/>
<meta name="robots" content="all">
<meta name="robots" content="index,follow">
<meta name="revisit-after" content="1 days"/>
<meta name="description" content="Güncel agario pvp serverleri burada! Serverini ekle ücretsiz tanıtımını yapmaya başla."/>
...
<link rel="canonical" href="<?=$siteayarlari["siteadresi"]?>/agario"/>
<meta name="x-canonical-url" content="/"/>

<meta property="og:locale" content="tr_TR" />
<meta property="og:type" content="website" />
<meta property="og:title" content="Agario Pvp Serverler | <?=$siteayarlari["siteadi"]?>" />
<meta property="og:description" content="Güncel agario pvp serverleri burada! Serverini ekle ücretsiz tanıtımını yapmaya başla." />
<meta property="og:url" content="<?='http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];?>">  
<meta property="og:site_name" content="<?=$siteayarlari["siteadi"]?>">

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:description" content="Güncel agario pvp serverleri burada! Serverini ekle ücretsiz tanıtımını yapmaya başla." />
<meta name="twitter:title" content="Agario Pvp Serverler | <?=$siteayarlari["siteadi"]?>" />
...
<div class="col-md-8">
	<div class="panel panel-black">
	   <div class="panel-heading">
	   			   			<h1 class="panel-title font-size-24">Agario Pvp Serverler</h1>
	   				</div>
...
$sorgu =mysqli_query($dbbaglanti,'SELECT COUNT(*) AS toplam FROM serverlar where serverkategori = "Agario"');
...
$sorgu =mysqli_query($dbbaglanti,'SELECT * FROM serverlar where serverkategori = "Agario" and servervip="hayir" order by id desc LIMIT ' . $limit . ', ' . $sayfada);
  ...
  echo'
  	...
  	<tr> 
<th scope="row">'.$iz++.'</th> 
<td><a href="'.$siteayarlari["siteadresi"].'/agario/'.$sonal["serverurl"].'">'.$sonal["serverbaslik"].'</a></td> 
...
if($sayfa != 0) echo '<a href="'.$siteayarlari["siteadresi"].'/agario/s/1" class="btn btn-black pull-left margin-right-5"><i class="fa fa-angle-double-left"></i></a> ';
 
if($sayfa == 1){

}else{
	$sayfadeger = $sayfa-1;
echo'	<a href="'.$siteayarlari["siteadresi"].'/agario/s/'.$sayfadeger.'" class="btn btn-black pull-left">Geri</a>';

}
 if($sayfa != $toplam_sayfa){ echo '
									<a href="'.$siteayarlari["siteadresi"].'/agario/s/'.$toplam_sayfa.'" class="btn btn-black pull-right"> <i class="fa fa-angle-double-right"></i></a>
...
';}
 if($sayfa == $toplam_sayfa){
	...
	$sayfadeger = $sayfa+1;
echo'	<a href="'.$siteayarlari["siteadresi"].'/agario/s/'.$sayfadeger.'" class="btn btn-black pull-right margin-right-5">İleri</a>';
