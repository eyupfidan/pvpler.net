...
<title>3D Oyunlar | Güncel Oyunlar HTML5, FLASH | <?=$siteayarlari["siteadi"]?></title>
<meta name="rating" content="general"/>
<meta name="robots" content="all">
<meta name="robots" content="index,follow">
<meta name="revisit-after" content="1 days"/>
<meta name="description" content="3D Oyunların tanıtımlarını buradan takip ederek HTML5 veya FLASH tabanlı en yeni oyunlardan ilk sen haberdar olabilirsin."/>
...
<link rel="canonical" href="<?=$siteayarlari["siteadresi"]?>/3doyunlar"/>
<meta name="x-canonical-url" content="/"/>

<meta property="og:locale" content="tr_TR" />
<meta property="og:type" content="website" />
<meta property="og:title" content="3D Oyunlar | Güncel Oyunlar HTML5, FLASH | <?=$siteayarlari["siteadi"]?>" />
<meta property="og:description" content="3D Oyunların tanıtımlarını buradan takip ederek HTML5 veya FLASH tabanlı en yeni oyunlardan ilk sen haberdar olabilirsin." />
<meta property="og:url" content="<?='http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];?>">  
<meta property="og:site_name" content="<?=$siteayarlari["siteadi"]?>">

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:description" content="3D Oyunların tanıtımlarını buradan takip ederek HTML5 veya FLASH tabanlı en yeni oyunlardan ilk sen haberdar olabilirsin." />
<meta name="twitter:title" content="3D Oyunlar | Güncel Oyunlar HTML5, FLASH | <?=$siteayarlari["siteadi"]?>" />
...
<div class="col-md-8">
	<div class="panel panel-black">
	   <div class="panel-heading">
	   			   			<h1 class="panel-title font-size-24">3D Oyunlar Pvp Serverler</h1>
	   				</div>
...
$sorgu =mysqli_query($dbbaglanti,'SELECT COUNT(*) AS toplam FROM serverlar where serverkategori = "3doyunlar"');
...
$sorgu =mysqli_query($dbbaglanti,'SELECT * FROM serverlar where serverkategori = "3doyunlar" and servervip="hayir" order by id desc LIMIT ' . $limit . ', ' . $sayfada);
  ...
  echo'
  	...
  	<tr> 
<th scope="row">'.$iz++.'</th> 
<td><a href="'.$siteayarlari["siteadresi"].'/3doyunlar/'.$sonal["serverurl"].'">'.$sonal["serverbaslik"].'</a></td> 
...
if($sayfa != 0) echo '<a href="'.$siteayarlari["siteadresi"].'/3doyunlar/s/1" class="btn btn-black pull-left margin-right-5"><i class="fa fa-angle-double-left"></i></a> ';
 
if($sayfa == 1){

}else{
	$sayfadeger = $sayfa-1;
echo'	<a href="'.$siteayarlari["siteadresi"].'/3doyunlar/s/'.$sayfadeger.'" class="btn btn-black pull-left">Geri</a>';

}
 if($sayfa != $toplam_sayfa){ echo '
									<a href="'.$siteayarlari["siteadresi"].'/3doyunlar/s/'.$toplam_sayfa.'" class="btn btn-black pull-right"> <i class="fa fa-angle-double-right"></i></a>
...
';}
 if($sayfa == $toplam_sayfa){
	...
	$sayfadeger = $sayfa+1;
echo'	<a href="'.$siteayarlari["siteadresi"].'/3doyunlar/s/'.$sayfadeger.'" class="btn btn-black pull-right margin-right-5">İleri</a>';
