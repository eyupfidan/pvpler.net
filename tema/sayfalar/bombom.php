...
<title>Bombom Pvp Serverler | Güncel PvP Serverlar 2020 | <?=$siteayarlari["siteadi"]?></title>
<meta name="rating" content="general"/>
<meta name="robots" content="all">
<meta name="robots" content="index,follow">
<meta name="revisit-after" content="1 days"/>
<meta name="description" content="BomBom pvp serverler tanıtımınızı ücretsiz yapabilirsiniz. Günde binlerce bombom oyuncusuna erişip serverinizi tanıtın!"/>
...
<link rel="canonical" href="<?=$siteayarlari["siteadresi"]?>/bombom"/>
<meta name="x-canonical-url" content="/"/>

<meta property="og:locale" content="tr_TR" />
<meta property="og:type" content="website" />
<meta property="og:title" content="Bombom Pvp Serverler | Güncel PvP Serverlar 2020 | <?=$siteayarlari["siteadi"]?>" />
<meta property="og:description" content="BomBom pvp serverler tanıtımınızı ücretsiz yapabilirsiniz. Günde binlerce bombom oyuncusuna erişip serverinizi tanıtın!" />
<meta property="og:url" content="<?='http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];?>">  
<meta property="og:site_name" content="<?=$siteayarlari["siteadi"]?>">  

<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:description" content="BomBom pvp serverler tanıtımınızı ücretsiz yapabilirsiniz. Günde binlerce bombom oyuncusuna erişip serverinizi tanıtın!" />
<meta name="twitter:title" content="Bombom Pvp Serverler | Güncel PvP Serverlar 2020 | <?=$siteayarlari["siteadi"]?>" />
...
<div class="col-md-8">
	<div class="panel panel-black">
	   <div class="panel-heading">
	   			   			<h1 class="panel-title font-size-24">Bombom Pvp Serverler</h1>
	   				</div>
...
$sorgu =mysqli_query($dbbaglanti,'SELECT COUNT(*) AS toplam FROM serverlar where serverkategori = "Bombom"');
...
$sorgu =mysqli_query($dbbaglanti,'SELECT * FROM serverlar where serverkategori = "Bombom" and servervip="hayir" order by id desc LIMIT ' . $limit . ', ' . $sayfada);
  ...
  echo'
  	...
  	<tr> 
<th scope="row">'.$iz++.'</th> 
<td><a href="'.$siteayarlari["siteadresi"].'/bombom/'.$sonal["serverurl"].'">'.$sonal["serverbaslik"].'</a></td> 
